...
class BamlSyncClient:
    ...
    def GenerateElasticCertificationQuestion(
      ...
      return cast(_baml.types.ElasticQuestion, raw.cast_to(_baml.types, _baml.types, _baml.partial_types, False))
...
class BamlStreamClient:
    ...
    def GenerateElasticCertificationQuestion(
        ...
        subject: _baml.types.Category,index: str,mapping: str,data: str,context: List[_baml.types.ElasticSet],
        baml_options: _baml.BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[_baml.partial_types.ElasticQuestion, _baml.types.ElasticQuestion]:
      options: _baml.BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[_baml.partial_types.ElasticQuestion, _baml.types.ElasticQuestion](
        raw,
        lambda x: cast(_baml.partial_types.ElasticQuestion, x.cast_to(_baml.types, _baml.types, _baml.partial_types, True)),
        lambda x: cast(_baml.types.ElasticQuestion, x.cast_to(_baml.types, _baml.types, _baml.partial_types, False)),
        self.__ctx_manager.get(),
      )
    ...
    def GenerateQuestionFromEnablementFile(
        ...
        enablementContent: str,questionBank: List[_baml.types.ElasticMultipleChooseSet],
        baml_options: _baml.BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[_baml.partial_types.ElasticMultipleChoose, _baml.types.ElasticMultipleChoose]:
      options: _baml.BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[_baml.partial_types.ElasticMultipleChoose, _baml.types.ElasticMultipleChoose](
        raw,
    ...
    def ValidateGeneratedQuestion(
        ...
        questionObject: _baml.types.ElasticMultipleChoose,enablementContent: str,
        baml_options: _baml.BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[_baml.partial_types.ElasticMultipleChooseValidation, _baml.types.ElasticMultipleChooseValidation]:
      options: _baml.BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[_baml.partial_types.ElasticMultipleChooseValidation, _baml.types.ElasticMultipleChooseValidation](
        raw,
