...
class BamlSyncClient:
    ...
    def GenerateElasticCertificationQuestion(self, subject: types.Category,index: str,mapping: str,data: str,context: typing.List["types.ElasticSet"],
        ...
        result = self.__options.merge_options(baml_options).call_function_sync(function_name="GenerateElasticCertificationQuestion", args={
...
class BamlStreamClient:
    ...
    def GenerateElasticCertificationQuestion(self, subject: types.Category,index: str,mapping: str,data: str,context: typing.List["types.ElasticSet"],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.ElasticQuestion, types.ElasticQuestion]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="GenerateElasticCertificationQuestion", args={
            "subject": subject,"index": index,"mapping": mapping,"data": data,"context": context,
        })
        return baml_py.BamlSyncStream[stream_types.ElasticQuestion, types.ElasticQuestion](
          result,
    ...
    def GenerateQuestionFromEnablementFile(self, enablementContent: str,questionBank: typing.List["types.ElasticMultipleTypeQuestionSet"],
        ...
        return baml_py.BamlSyncStream[stream_types.ElasticMultipleTypeQuestion, types.ElasticMultipleTypeQuestion](
          result,
    ...
    def ValidateGeneratedQuestion(self, questionObject: types.ElasticMultipleTypeQuestion,enablementContent: str,
        ...
        return baml_py.BamlSyncStream[stream_types.ElasticMultipleTypeQuestionValidation, types.ElasticMultipleTypeQuestionValidation](
          result,
...
class BamlHttpRequestClient:
    ...
    def GenerateElasticCertificationQuestion(self, subject: types.Category,index: str,mapping: str,data: str,context: typing.List["types.ElasticSet"],
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="GenerateElasticCertificationQuestion", args={
            "subject": subject,"index": index,"mapping": mapping,"data": data,"context": context,
        }, mode="request")
        return result
    def GenerateQuestionFromEnablementFile(self, enablementContent: str,questionBank: typing.List["types.ElasticMultipleTypeQuestionSet"],
